...
/// Fade out Particle effect with controller
@immutable
class FadeOutParticleControlled extends StatefulWidget {
  const FadeOutParticleControlled({
    Key? key,
  ...
  @override
  State<FadeOutParticleControlled> createState() =>
      _FadeOutParticleControlledState();
}

class _FadeOutParticleControlledState extends State<FadeOutParticleControlled> {
